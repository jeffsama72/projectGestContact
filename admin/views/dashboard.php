    ...
    <div class="main-panel">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($listeClients as $client) {
                                      ...
                                      echo '<td>' . $client->getEmail() . '</td>';
                                      echo '<td>' . $client->getNomFormation() . '</td>';
                                      echo '<td><button><a href="./index.php?action=formEditClient&id=' . $client->getId() . '"">Editer</a></button></td>';
                                      echo '</tr>';  
                                    }
                                ?>
                             </tbody>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($listeClients as $client) {
                                      ...
                                      echo '<td>' . $client->getEmail() . '</td>';
                                      echo '<td>' . $client->getNomFormation() . '</td>';
                                      echo '<td><button><a href="./index.php?action=deleteClient&id=' . $client->getId() . '">Supprimer</a></button></td>';
                                      echo '</tr>';  
                                    }
                                ?>
                             </tbody>
        ...
        <div class="content">
            <div class="content-fluid">
                <div class="row" id="exportBase">
                    <div class="col-lg-12">
                       <button><a href="./index.php?action=export">Export</a></button>
                    </div>
                </div>
            </div>
        </div>
